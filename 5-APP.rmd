              ...
              fluidRow(
                ...
                column(
                  ...
                  box(
                    ...
                    solidHeader = TRUE,
                    status = "primary",
                    textOutput("growthTextGermany_1")
                  )
                )
              ),
              fluidRow(
...
server <- function(input, output) {
  ...
  goal_names <- c("Goal1", "Goal2", "Goal3", "Goal4", "Goal5", "Goal6", "Goal7", "Goal8", "Goal9", "Goal10", "Goal11", "Goal12", "Goal13", "Goal14", "Goal15", "Goal16", "Goal17")
  # Generate outputs for each goal
  for (goal in goal_names) {
    output[[paste0("growthTextSpain_", goal)]] <- renderText({
      calculateGrowthRate("Spain", goal)
    })
    
    output[[paste0("growthTextGermany_", goal)]] <- renderText({
      calculateGrowthRate("Germany", goal)
    })
  }
...
```{r}
calculateGrowthRate <- function(country, indicator) {
  ...
  if (growth_indicator >= 0) {
    growth_text <- paste0("Growth (", country, "): +", growth_indicator, "%")
  } else {
    growth_text <- paste0("Growth (", country, "): -", growth_indicator, "%")
  }
